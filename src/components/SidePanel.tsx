...
// The GitHub mark (Octicons), for the source link in the menu footer.
function GitHubIcon() {
  return (
    ...
    <>
      ...
      >
        ...
        <div className="flex flex-1 flex-col gap-5 overflow-y-auto p-5">
          ...
          />
          {children?.(close)}
          {/* Footer: the project's source, pinned to the bottom of the drawer. */}
          <a
            href="https://github.com/Mualig/webrtc-dice-player"
            target="_blank"
            rel="noreferrer"
            aria-label="View the project on GitHub"
            title="View the project on GitHub"
            className="mt-auto self-center rounded-lg p-2 text-zinc-400 transition hover:bg-zinc-100 hover:text-zinc-900"
          >
            <GitHubIcon />
          </a>
        </div>
